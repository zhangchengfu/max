...
public class POIDocHelper {
    ...
    public void addParagraphTextHyperlink(XWPFParagraph paragraph, String url,
        ...
        // 设置超链接样式
        // 字体颜色
        if (StrUtil.isNotBlank(colorVal)) {
    ...
    public void setDocumentMargin(XWPFDocument document, String left,
        ...
        if (StrUtil.isNotBlank(left)) {
            ctpagemar.setLeft(new BigInteger("850"));
        }
        if (StrUtil.isNotBlank(top)) {
            ctpagemar.setTop(new BigInteger("567"));
        }
        if (StrUtil.isNotBlank(right)) {
            ctpagemar.setRight(new BigInteger("850"));
        }
        if (StrUtil.isNotBlank(bottom)) {
            ctpagemar.setBottom(new BigInteger("567"));
        }
    }
